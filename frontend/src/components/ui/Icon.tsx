...
const paths: Record<IconName, ReactNode> = {
  ...
  droplet: <path d="M12 3s6 6.1 6 10.4A6 6 0 0 1 6 13.4C6 9.1 12 3 12 3Z" />,
  ...
  paint: <path d="M4 7h10v5H4V7Zm8 5v7a2 2 0 0 1-2 2h0a2 2 0 0 1-2-2v-7m6-5h3a3 3 0 0 1 0 6h-3" />,
  phone: <path d="M7 5 5 7c1 6 6 11 12 12l2-2-4-4-2 2c-2-1-4-3-5-5l2-2-3-3Z" />,
  plug: <path d="M9 3v6M15 3v6M7 9h10v4a5 5 0 0 1-10 0V9Zm5 9v3" />,
  ...
  user: <path d="M20 21a8 8 0 0 0-16 0M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10Z" />,
